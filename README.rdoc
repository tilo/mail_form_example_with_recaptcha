...
4. Customize this example to fit your needs:
   * add your reCaptcha account information
       emacs config/initializers/recaptcha.rb   # add your private and public keys

   * add your email settings
       emacs config/initializers/setup_mail.rb  # add your domain name
       emacs app/models/mail_forms/contact.rb   # add the email address where you want to receive the form data
...
5. Try out the Example
   ...
   Point your browser to 
         firefox http://localhost/contact


Enjoy!

== Appendix
   Here's the list of relevant files:
